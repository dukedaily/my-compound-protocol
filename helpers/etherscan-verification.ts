...
export const SUPPORTED_ETHERSCAN_NETWORKS = ['main', 'ropsten', 'kovan', 'hardhat'];
...
export const verifyContract = async (
  ...
  console.log("verifyContract called!");
  ...
  try {
     ...
     *  params: {
            ...
            libraries: undefined,
            constructorArgs: '/var/folders/n8/wzftkqn544b_wscv8f_7hw7r0000gn/T/verify-params--19812-jV2zzsUrkn7Q-.js',
            relatedSources: true
        }
        
        constructorArgs文件内容格式为：
        module.exports = ["1000000000000000000000000000","Publ BUSD","18","BUSD"];
    */
