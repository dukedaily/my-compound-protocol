...
contract PErc20Delegator is PTokenInterface, PErc20Interface, PDelegatorInterface {
    /**
     * @notice Construct a new money market
     * @param underlying_ The address of the underlying asset
     * @param underlyingDecimal_ ERC-20 decimal precision of this underlying token
    ...
    constructor(
        ...
        delegateTo(
            ...
            abi.encodeWithSignature(
                "initialize(address,uint8,address,address,address,uint256,string,string,uint8)",
                underlying_,
                underlyingDecimal_,
                comptroller_,
                interestRateModel_,
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details), mintPTokens
     */
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details), tokenAmount, pTokenAmount
     */
    ...
    */
    ...
    //信用贷相关
    function setWhiteList(address trust, bool _state) public {
        // bytes memory data = delegateToImplementation(abi.encodeWithSignature("setWhiteList(address,bool)", trust, _state));
        // return abi.decode(data, (uint256));
        delegateToImplementation(abi.encodeWithSignature("setWhiteList(address,bool)", trust, _state));
    }
    ...
    function doCreditLoanMint(
        ...
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("doCreditLoanMint(address,uint256,uint8)", _minter, _mintAmount, _loanType));
        return abi.decode(data, (uint256, uint256));
    }
    ...
    function doCreditLoanRedeem(
        ...
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("doCreditLoanRedeem(address,uint256,uint256,uint8)", _redeemer, _redeemAmount, _redeemTokensAmount, _loanType));
        return abi.decode(data, (uint256, uint256, uint256));
    }
}
