...
import {createBigNumber6, createBigNumber8, createBigNumber18} from '../helpers/constants'

export const PublicConfig = {
    PriceOracleAggregator: {
        [eEthereumNetwork.hardhat]: {
            UNI: createBigNumber18(23),
            BUSD: createBigNumber18(1),
            DAI: createBigNumber18(2),
            WBTC: createBigNumber8(1000),
            USDT: createBigNumber6(1),
        },
        [eEthereumNetwork.kovan]: {
            ORACLESEED: '0xD82aBeeD913fE077d6291DaA6bA989867492848a',
            // USDT: '0x0bF499444525a23E7Bb61997539725cA2e928138',
            // BUSD: '0xbF7A18ea5DE0501f7559144e702b29c55b055CcB',
        },
    },
    ReservesConfig: { //在这里控制币种
        UNI: strategyUNI,
        BUSD: strategyBUSD,
        DAI: strategyDAI,
        WBTC: strategyWBTC,
    ...
    ReserveAssets: {
        [eEthereumNetwork.hardhat]: {
            UNI: '0x7c2C195CD6D34B8F845992d380aADB2730bB9C6F',
            BUSD: '0x8858eeB3DfffA017D4BCE9801D340D36Cf895CCf',
            DAI: '0x0078371BDeDE8aAc7DeBfFf451B74c5EDB385Af7',
            WBTC: '0xf4e77E5Da47AC3125140c470c71cBca77B5c638c',
            USDT: '0xf784709d2317D872237C4bC22f867d1BAe2913AB',
        },
        [eEthereumNetwork.kovan]: {
